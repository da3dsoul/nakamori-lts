...
class SchemaFor200ResponseBodyTextPlain(
    ...
    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SeriesTvDB'], typing.List['SeriesTvDB']],
    ...
    def __getitem__(self, i: int) -> 'SeriesTvDB':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _series_series_idtv_db_get_oapg(
        self,
...
class SeriesSeriesIdtvDbGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def series_series_idtv_db_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def series_series_idtv_db_get(
        ...
        return self._series_series_idtv_db_get_oapg(
