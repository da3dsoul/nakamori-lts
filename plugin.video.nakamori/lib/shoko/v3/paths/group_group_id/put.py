...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = InputCreateOrUpdateGroupBody
SchemaForRequestBodyApplicationJson = InputCreateOrUpdateGroupBody
SchemaForRequestBodyTextJson = InputCreateOrUpdateGroupBody
SchemaForRequestBodyApplicationJson = InputCreateOrUpdateGroupBody


request_body_input_create_or_update_group_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _group_group_id_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_input_create_or_update_group_body.serialize(body, content_type)
...
class GroupGroupIdPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def group_group_id_put(
        self,
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def group_group_id_put(
        ...
        return self._group_group_id_put_oapg(
            body=body,
