...
SchemaFor200ResponseBodyTextPlain = ListResultEpisodeAniDB
SchemaFor200ResponseBodyApplicationJson = ListResultEpisodeAniDB
SchemaFor200ResponseBodyTextJson = ListResultEpisodeAniDB
...
class EpisodeAniDbGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def episode_ani_db_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def episode_ani_db_get(
        ...
        return self._episode_ani_db_get_oapg(
