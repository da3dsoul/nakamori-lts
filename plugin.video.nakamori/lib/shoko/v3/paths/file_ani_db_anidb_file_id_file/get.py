...
# Path params
AnidbFileIDSchema = schemas.Int32Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'anidbFileID': typing.Union[AnidbFileIDSchema, decimal.Decimal, int, ],
    }
)
...
request_path_anidb_file_id = api_client.PathParameter(
    name="anidbFileID",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AnidbFileIDSchema,
    required=True,
)
_auth = [
    'ApiKey',
]
SchemaFor200ResponseBodyTextPlain = ShokoFile
SchemaFor200ResponseBodyApplicationJson = ShokoFile
SchemaFor200ResponseBodyTextJson = ShokoFile
...
class BaseApi(api_client.Api):
    @typing.overload
    def _file_ani_db_anidb_file_id_file_get_oapg(
        self,
...
class FileAniDbAnidbFileIdFileGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def file_ani_db_anidb_file_id_file_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def file_ani_db_anidb_file_id_file_get(
        ...
        return self._file_ani_db_anidb_file_id_file_get_oapg(
