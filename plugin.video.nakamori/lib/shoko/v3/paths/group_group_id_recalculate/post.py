...
class BaseApi(api_client.Api):
    @typing.overload
    def _group_group_id_recalculate_post_oapg(
        self,
...
class GroupGroupIdRecalculatePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def group_group_id_recalculate_post(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def group_group_id_recalculate_post(
        ...
        return self._group_group_id_recalculate_post_oapg(
