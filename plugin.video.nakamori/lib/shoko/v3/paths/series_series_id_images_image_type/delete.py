...
class BaseApi(api_client.Api):
    @typing.overload
    def _series_series_id_images_image_type_delete_oapg(
        self,
...
class SeriesSeriesIdImagesImageTypeDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def series_series_id_images_image_type_delete(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def series_series_id_images_image_type_delete(
        ...
        return self._series_series_id_images_image_type_delete_oapg(
