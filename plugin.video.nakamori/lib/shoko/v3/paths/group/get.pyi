...
StartsWithSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'startsWith': typing.Union[StartsWithSchema, str, ],
    },
    total=False
)
...
request_query_starts_with = api_client.QueryParameter(
    name="startsWith",
    style=api_client.ParameterStyle.FORM,
