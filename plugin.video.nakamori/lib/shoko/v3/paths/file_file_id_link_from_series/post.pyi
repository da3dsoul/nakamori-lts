...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = InputLinkSeriesBody
SchemaForRequestBodyApplicationJson = InputLinkSeriesBody
SchemaForRequestBodyTextJson = InputLinkSeriesBody
SchemaForRequestBodyApplicationJson = InputLinkSeriesBody


request_body_input_link_series_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _file_file_id_link_from_series_post_oapg(
        self,
    ...
    def _file_file_id_link_from_series_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_input_link_series_body.serialize(body, content_type)
...
class FileFileIdLinkFromSeriesPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def file_file_id_link_from_series_post(
        self,
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def file_file_id_link_from_series_post(
        ...
        return self._file_file_id_link_from_series_post_oapg(
            body=body,
