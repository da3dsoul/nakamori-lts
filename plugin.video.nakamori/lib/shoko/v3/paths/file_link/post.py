...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = InputLinkMultipleFilesBody
SchemaForRequestBodyApplicationJson = InputLinkMultipleFilesBody
SchemaForRequestBodyTextJson = InputLinkMultipleFilesBody
SchemaForRequestBodyApplicationJson = InputLinkMultipleFilesBody


request_body_input_link_multiple_files_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _file_link_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_input_link_multiple_files_body.serialize(body, content_type)
...
class FileLinkPost(BaseApi):
    ...
    def file_link_post(
        ...
        return self._file_link_post_oapg(
            body=body,
