...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = InputCreateUserBody
SchemaForRequestBodyApplicationJson = InputCreateUserBody
SchemaForRequestBodyTextJson = InputCreateUserBody
SchemaForRequestBodyApplicationJson = InputCreateUserBody


request_body_input_create_user_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _user_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_input_create_user_body.serialize(body, content_type)
