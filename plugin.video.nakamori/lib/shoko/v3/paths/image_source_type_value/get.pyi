...
# Path params
SourceSchema = ImageImageSource
TypeSchema = ImageImageType
ValueSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'source': typing.Union[SourceSchema, ],
...
SchemaFor404ResponseBodyTextPlain = MvcProblemDetails
SchemaFor404ResponseBodyApplicationJson = MvcProblemDetails
SchemaFor404ResponseBodyTextJson = MvcProblemDetails
...
class BaseApi(api_client.Api):
    @typing.overload
    def _image_source_type_value_get_oapg(
        self,
...
class ImageSourceTypeValueGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def image_source_type_value_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def image_source_type_value_get(
        ...
        return self._image_source_type_value_get_oapg(
