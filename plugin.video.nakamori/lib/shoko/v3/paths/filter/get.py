...
class PageSchema(
    ...
    class MetaOapg:
        ...
        inclusive_minimum = 1
WithConditionsSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'withConditions': typing.Union[WithConditionsSchema, bool, ],
    },
    total=False
)
...
request_query_with_conditions = api_client.QueryParameter(
    name="withConditions",
    style=api_client.ParameterStyle.FORM,
    schema=WithConditionsSchema,
    explode=True,
)
_auth = [
    'ApiKey',
]
SchemaFor200ResponseBodyTextPlain = ListResultShokoFilter
SchemaFor200ResponseBodyApplicationJson = ListResultShokoFilter
SchemaFor200ResponseBodyTextJson = ListResultShokoFilter
