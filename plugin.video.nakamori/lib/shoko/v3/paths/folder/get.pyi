...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ShokoFolder']:
            return ShokoFolder

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ShokoFolder'], typing.List['ShokoFolder']],
    ...
    def __getitem__(self, i: int) -> 'ShokoFolder':
