...
class BaseApi(api_client.Api):
    @typing.overload
    def _dashboard_recently_added_series_get_oapg(
        self,
...
class DashboardRecentlyAddedSeriesGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def dashboard_recently_added_series_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def dashboard_recently_added_series_get(
        ...
        return self._dashboard_recently_added_series_get_oapg(
