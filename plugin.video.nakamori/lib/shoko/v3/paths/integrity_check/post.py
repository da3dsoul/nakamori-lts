...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = ServerScan
SchemaForRequestBodyApplicationJson = ServerScan
SchemaForRequestBodyTextJson = ServerScan
SchemaForRequestBodyApplicationJson = ServerScan


request_body_server_scan = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = ServerScan
SchemaFor200ResponseBodyApplicationJson = ServerScan
SchemaFor200ResponseBodyTextJson = ServerScan
...
class BaseApi(api_client.Api):
    @typing.overload
    def _integrity_check_post_oapg(
        self,
    ...
    def _integrity_check_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_server_scan.serialize(body, content_type)
...
class IntegrityCheckPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def integrity_check_post(
        self,
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def integrity_check_post(
        ...
        return self._integrity_check_post_oapg(
            body=body,
