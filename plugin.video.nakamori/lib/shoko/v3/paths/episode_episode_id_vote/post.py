...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = CommonVote
SchemaForRequestBodyApplicationJson = CommonVote
SchemaForRequestBodyTextJson = CommonVote
SchemaForRequestBodyApplicationJson = CommonVote


request_body_common_vote = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _episode_episode_id_vote_post_oapg(
        self,
    ...
    def _episode_episode_id_vote_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_common_vote.serialize(body, content_type)
...
class EpisodeEpisodeIdVotePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def episode_episode_id_vote_post(
        self,
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def episode_episode_id_vote_post(
        ...
        return self._episode_episode_id_vote_post_oapg(
            body=body,
