...
class BaseApi(api_client.Api):
    @typing.overload
    def _series_series_id_auto_match_settings_patch_oapg(
        self,
...
class SeriesSeriesIdAutoMatchSettingsPatch(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def series_series_id_auto_match_settings_patch(
        self,
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, list, tuple, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def series_series_id_auto_match_settings_patch(
        ...
        return self._series_series_id_auto_match_settings_patch_oapg(
            body=body,
