...
IsManuallyLinkedSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'isManuallyLinked': typing.Union[IsManuallyLinkedSchema, bool, ],
...
request_query_is_manually_linked = api_client.QueryParameter(
    name="isManuallyLinked",
    style=api_client.ParameterStyle.FORM,
    schema=IsManuallyLinkedSchema,
    explode=True,
)
...
request_path_episode_id = api_client.PathParameter(
    name="episodeID",
...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ShokoFile']:
            return ShokoFile

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ShokoFile'], typing.List['ShokoFile']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'ShokoFile':
        return super().__getitem__(i)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _episode_episode_id_file_get_oapg(
        self,
    ...
    def _episode_episode_id_file_get_oapg(
        ...
        for parameter in (
            ...
            request_query_is_manually_linked,
...
class EpisodeEpisodeIdFileGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def episode_episode_id_file_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def episode_episode_id_file_get(
        ...
        return self._episode_episode_id_file_get_oapg(
