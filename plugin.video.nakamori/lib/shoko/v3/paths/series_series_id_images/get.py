...
SchemaFor200ResponseBodyTextPlain = CommonImages
SchemaFor200ResponseBodyApplicationJson = CommonImages
SchemaFor200ResponseBodyTextJson = CommonImages
...
class BaseApi(api_client.Api):
    @typing.overload
    def _series_series_id_images_get_oapg(
        self,
...
class SeriesSeriesIdImagesGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def series_series_id_images_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def series_series_id_images_get(
        ...
        return self._series_series_id_images_get_oapg(
