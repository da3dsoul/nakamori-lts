...
class BaseApi(api_client.Api):
    @typing.overload
    def _action_rename_all_groups_get_oapg(
        self,
        stream: bool = False,
...
class ActionRenameAllGroupsGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def action_rename_all_groups_get(
        self,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
        skip_deserialization: typing_extensions.Literal[False] = ...,
    ...
    def action_rename_all_groups_get(
        ...
        return self._action_rename_all_groups_get_oapg(
            stream=stream,
            timeout=timeout,
