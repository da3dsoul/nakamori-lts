...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ShokoEpisode']:
            return ShokoEpisode

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ShokoEpisode'], typing.List['ShokoEpisode']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'ShokoEpisode':
        return super().__getitem__(i)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _file_file_id_episode_get_oapg(
        self,
...
class FileFileIdEpisodeGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def file_file_id_episode_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def file_file_id_episode_get(
        ...
        return self._file_file_id_episode_get_oapg(
