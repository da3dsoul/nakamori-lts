...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = InputUnlinkEpisodesBody
SchemaForRequestBodyApplicationJson = InputUnlinkEpisodesBody
SchemaForRequestBodyTextJson = InputUnlinkEpisodesBody
SchemaForRequestBodyApplicationJson = InputUnlinkEpisodesBody


request_body_input_unlink_episodes_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _file_file_id_link_delete_oapg(
        self,
    ...
    def _file_file_id_link_delete_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_input_unlink_episodes_body.serialize(body, content_type)
...
class FileFileIdLinkDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def file_file_id_link_delete(
        self,
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def file_file_id_link_delete(
        ...
        return self._file_file_id_link_delete_oapg(
            body=body,
