...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = InputChangePasswordBody
SchemaForRequestBodyApplicationJson = InputChangePasswordBody
SchemaForRequestBodyTextJson = InputChangePasswordBody
SchemaForRequestBodyApplicationJson = InputChangePasswordBody


request_body_input_change_password_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _user_current_change_password_post_oapg(
        self,
    ...
    def _user_current_change_password_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_input_change_password_body.serialize(body, content_type)
...
class UserCurrentChangePasswordPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def user_current_change_password_post(
        self,
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, schemas.Unset] = schemas.unset,
        stream: bool = False,
    ...
    def user_current_change_password_post(
        ...
        return self._user_current_change_password_post_oapg(
            body=body,
