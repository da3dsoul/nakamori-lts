...
class BaseApi(api_client.Api):
    @typing.overload
    def _series_series_id_move_group_id_patch_oapg(
        self,
...
class SeriesSeriesIdMoveGroupIdPatch(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def series_series_id_move_group_id_patch(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def series_series_id_move_group_id_patch(
        ...
        return self._series_series_id_move_group_id_patch_oapg(
