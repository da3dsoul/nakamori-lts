...
class BaseApi(api_client.Api):
    @typing.overload
    def _import_folder_folder_id_scan_get_oapg(
        self,
...
class ImportFolderFolderIdScanGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def import_folder_folder_id_scan_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def import_folder_folder_id_scan_get(
        ...
        return self._import_folder_folder_id_scan_get_oapg(
