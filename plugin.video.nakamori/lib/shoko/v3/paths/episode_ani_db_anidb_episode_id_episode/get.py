...
# Path params
AnidbEpisodeIDSchema = schemas.Int32Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'anidbEpisodeID': typing.Union[AnidbEpisodeIDSchema, decimal.Decimal, int, ],
    }
)
...
request_path_anidb_episode_id = api_client.PathParameter(
    name="anidbEpisodeID",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AnidbEpisodeIDSchema,
    required=True,
)
_auth = [
    'ApiKey',
]
SchemaFor200ResponseBodyTextPlain = ShokoEpisode
SchemaFor200ResponseBodyApplicationJson = ShokoEpisode
SchemaFor200ResponseBodyTextJson = ShokoEpisode
...
class BaseApi(api_client.Api):
    @typing.overload
    def _episode_ani_db_anidb_episode_id_episode_get_oapg(
        self,
...
class EpisodeAniDbAnidbEpisodeIdEpisodeGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def episode_ani_db_anidb_episode_id_episode_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def episode_ani_db_anidb_episode_id_episode_get(
        ...
        return self._episode_ani_db_anidb_episode_id_episode_get_oapg(
