...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = InputCreateOrUpdateFilterBody
SchemaForRequestBodyApplicationJson = InputCreateOrUpdateFilterBody
SchemaForRequestBodyTextJson = InputCreateOrUpdateFilterBody
SchemaForRequestBodyApplicationJson = InputCreateOrUpdateFilterBody


request_body_input_create_or_update_filter_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = InputCreateOrUpdateFilterBody
SchemaFor200ResponseBodyApplicationJson = InputCreateOrUpdateFilterBody
SchemaFor200ResponseBodyTextJson = InputCreateOrUpdateFilterBody
...
class BaseApi(api_client.Api):
    ...
    def _filter_preview_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_input_create_or_update_filter_body.serialize(body, content_type)
...
class FilterPreviewPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def filter_preview_put(
        self,
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def filter_preview_put(
        ...
        return self._filter_preview_put_oapg(
            body=body,
