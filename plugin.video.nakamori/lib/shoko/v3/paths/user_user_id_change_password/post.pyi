...
class BaseApi(api_client.Api):
    @typing.overload
    def _user_user_id_change_password_post_oapg(
        self,
...
class UserUserIdChangePasswordPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def user_user_id_change_password_post(
        self,
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def user_user_id_change_password_post(
        ...
        return self._user_user_id_change_password_post_oapg(
            body=body,
