...
class ShokoFolder(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Path"], typing_extensions.Literal["IsAccessible"], typing_extensions.Literal["Sizes"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Path"], typing_extensions.Literal["IsAccessible"], typing_extensions.Literal["Sizes"], ]):
