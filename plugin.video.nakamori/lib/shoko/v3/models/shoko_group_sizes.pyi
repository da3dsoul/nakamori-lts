...
class ShokoGroupSizes(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def SeriesTypes() -> typing.Type['GroupSizesSeriesTypeCounts']:
                return GroupSizesSeriesTypeCounts
    ...
    SeriesTypes: 'GroupSizesSeriesTypeCounts'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["SeriesTypes"]) -> 'GroupSizesSeriesTypeCounts': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Total"], typing_extensions.Literal["Local"], typing_extensions.Literal["SeriesTypes"], typing_extensions.Literal["FileSources"], typing_extensions.Literal["SubGroups"], typing_extensions.Literal["Missing"], typing_extensions.Literal["Hidden"], typing_extensions.Literal["Watched"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SeriesTypes"]) -> 'GroupSizesSeriesTypeCounts': ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        SeriesTypes: 'GroupSizesSeriesTypeCounts',
        FileSources: 'SeriesSizesFileSourceCounts',
        SubGroups: typing.Union[MetaOapg.properties.SubGroups, decimal.Decimal, int, schemas.Unset] = schemas.unset,
...
from lib.shoko.v3.lib.shoko.v3.models.group_sizes_series_type_counts import GroupSizesSeriesTypeCounts
