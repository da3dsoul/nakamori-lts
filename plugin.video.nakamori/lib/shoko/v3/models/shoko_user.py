...
class ShokoUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ID"], typing_extensions.Literal["Username"], typing_extensions.Literal["IsAdmin"], typing_extensions.Literal["CommunitySites"], typing_extensions.Literal["RestrictedTags"], typing_extensions.Literal["Avatar"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ID"], typing_extensions.Literal["Username"], typing_extensions.Literal["IsAdmin"], typing_extensions.Literal["CommunitySites"], typing_extensions.Literal["RestrictedTags"], typing_extensions.Literal["Avatar"], ]):
